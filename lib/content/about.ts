...
export const ABOUT_BLOCKS = [
  { key: 'architecture', src: '/images/gallery/za-vilata-prostranstvo-otvun.webp', reversed: false },
  { key: 'interior', src: '/images/gallery/za-vilata-prostranstvo.webp', reversed: true },
  { key: 'garden', src: '/images/gallery/za-vilata-gradinata-2.webp', reversed: false },
  { key: 'wellness', src: '/images/gallery/za-vilata-basein.webp', reversed: true },
] as const satisfies readonly AboutBlock[]

export const AMENITY_GROUP_KEYS = ['accommodation', 'wellness', 'services'] as const
